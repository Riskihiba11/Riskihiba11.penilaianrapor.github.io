...
if (isset($_POST['create_student'])) {
    ...
    if (!empty($photo_name) && strpos($photo_name, "Terjadi kesalahan") === false && strpos($photo_name, "File bukan gambar") === false && strpos($photo_name, "Hanya file") === false) {
        $sql = "INSERT INTO students (nis, student_name, student_class, gender, place_of_birth, date_of_birth, religion, previous_education, student_address, father_name, mother_name, father_job, mother_job, parent_address, guardian_name, guardian_job, guardian_address, photo) 
                VALUES ('$nis', '$student_name', '$student_class', '$gender', '$place_of_birth', '$date_of_birth', '$religion', '$previous_education', '$student_address', '$father_name', '$mother_name', '$father_job', '$mother_job', '$parent_address', '$guardian_name', '$guardian_job', '$guardian_address', '$photo_name')";
